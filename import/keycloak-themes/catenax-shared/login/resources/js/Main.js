...
class FormLogin extends Form {
    ...
    constructor(form) {
        super(
            N('div', [
                N('h3', 'Register to Railway-X'),
                N('p', 'Finish the company registration form to join Railway-X automotive network. Please use your email address as username and enter your password.'),
                form
            ])
        )
        setTimeout((() => {
